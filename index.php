          ...
          <div class="card">
            <div class="row">
              ...
              <i class="fa fa-location-arrow prefix"></i>
                <input id="start" type="text" class="validate" autocomplete="off">
                <label for="start">Start</label>
              </div>
              <div class="input-field col l6 s12">
                <i class="fa fa-map-marker prefix"></i>
                <input id="destination" type="text" class="validate" autocomplete="off">
            ...
            <button onclick="" type="submit" class="left btn btn-spacer waves-effect wave-dark loginbtn btnColor center-align">Traffic</button>
            <div class="fixed-action-btn horizontal click-to-toggle" style="bottom: 45px; right: 24px;">
              <a class="btn-floating btn-large red">
                <i class="material-icons">menu</i>
              </a>
              <ul>
                <li><a class="btn-floating green"><i class="material-icons">add</i>Update Traffic</a></li>  
              </ul>
            </div>
          </div>
        </div>
